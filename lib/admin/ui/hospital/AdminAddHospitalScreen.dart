...
class AdminAddHospitalScreen extends StatefulWidget {
  @override
  _AdminAddHospitalScreenState createState() => _AdminAddHospitalScreenState();
}

class _AdminAddHospitalScreenState extends State<AdminAddHospitalScreen> {
  final GlobalKey<FormBuilderState> _fbKey = GlobalKey<FormBuilderState>();

  _addDataHospital(name, address, city, longitude, latitude) async {
    print("Tombol Tambah Berhasil di Tekan");
    String url =
        'https://mp-covid19-api.000webhostapp.com/public/api/case/save';
    Map<String, String> headers = {"Content-type": "application/json"};
    String json =
        '{"confirmed_cases": "$name", "total_deaths": "$address", "city": "$city", "longitude": "$longitude", "latitude": "$latitude"}';
    print(json);
