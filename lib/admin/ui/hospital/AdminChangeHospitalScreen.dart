...
class AdminChangeHospitalScreen extends StatefulWidget {
  final int id;
  final String name;
  ...
  AdminChangeHospitalScreen({this.id, this.name, this.address, this.city, this.longitude, this.latitude});
  @override
  _AdminChangeHospitalScreenState createState() => _AdminChangeHospitalScreenState();
}

class _AdminChangeHospitalScreenState extends State<AdminChangeHospitalScreen> {
  final GlobalKey<FormBuilderState> _fbKey = GlobalKey<FormBuilderState>();


  _changeDataHospital(name, address, city, longitude, latitude) async {
    print("Tombol Ubah Berhasil di Tekan");
    String url =
        'https://mp-covid19-api.000webhostapp.com/public/api/hospital/${widget.id}/update';
              ...
              child: new Column(
                children: <Widget>[
                  ...
                  FormBuilderTextField(
                    ...
                    decoration:
                    InputDecoration(labelText: "Alamat Rumah Sakit"),
                    validators: [
                      FormBuilderValidators.required(),
                    ],
                  ),
